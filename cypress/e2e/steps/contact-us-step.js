...
class ContactUsStep extends GeneralStep {
  ...
  verifyAllFieldsAreRequaredErrorExists() {
    ContactUsPage.getAllFieldsAreRequaredError.should('exist');
  }

  veriryInvalidEmailErrorExists() {
    ContactUsPage.getInvalidEmailError.should('exist');
  }

  veriryInvalidEmailErrorNotExists() {
    ContactUsPage.getInvalidEmailError.should('not.exist');
  }
}

export { ContactUsStep }